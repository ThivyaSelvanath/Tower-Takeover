...
void autonomous (void) {
  ...
  intakeL.startRotateFor(-240,rotationUnits::deg,60,velocityUnits::pct);
  intakeR.rotateFor(-240,rotationUnits::deg,60,velocityUnits::pct);
  ...
  baseFRight.rotateFor(-300,rotationUnits::deg,50,velocityUnits::pct,false);
  baseBRight.rotateFor(-300,rotationUnits::deg,50,velocityUnits::pct,false);
  baseFLeft.rotateFor(-300,rotationUnits::deg,50,velocityUnits::pct,false);
  baseBLeft.rotateFor(-300,rotationUnits::deg,50,velocityUnits::pct);
