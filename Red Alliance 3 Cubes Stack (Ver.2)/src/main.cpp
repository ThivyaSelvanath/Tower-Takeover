...
void autonomous (void) {
  ...
  baseFRight.rotateFor(500,rotationUnits::deg,55,velocityUnits::pct,false);
  baseBRight.rotateFor(500,rotationUnits::deg,55,velocityUnits::pct,false);
  baseFLeft.rotateFor(500,rotationUnits::deg,55,velocityUnits::pct,false);
  baseBLeft.rotateFor(500,rotationUnits::deg,55,velocityUnits::pct); 

  //0.3 second rest
  task::sleep(300);

  //intakes spin outwards to move the cubes down the holder 
  ...
  Holder.startRotateFor(-330,rotationUnits::deg,40,velocityUnits::pct);
  ...
  intakeL.startRotateFor(-400,rotationUnits::deg,25,velocityUnits::pct);
  intakeR.rotateFor(-400,rotationUnits::deg,25,velocityUnits::pct,false);
