...
void autonomous (void) {
  ...
  intakeL.startRotateFor(400,rotationUnits::deg,75,velocityUnits::pct);
  intakeR.rotateFor(400,rotationUnits::deg,75,velocityUnits::pct);

  task::sleep(500);

  baseFRight.startRotateFor(400,rotationUnits::deg,69,velocityUnits::pct);
  baseBRight.rotateFor(400,rotationUnits::deg,60,velocityUnits::pct,false);
  baseFLeft.rotateFor(400,rotationUnits::deg,60,velocityUnits::pct,false);
  baseBLeft.rotateFor(400,rotationUnits::deg,60,velocityUnits::pct); 

  task::sleep(200);

  //intakes spin inwards to pick up 4 cubes as the robot moves forward
  intakeL.startRotateFor(2800,rotationUnits::deg,75,velocityUnits::pct);
  intakeR.rotateFor(2800,rotationUnits::deg,75,velocityUnits::pct,false);
  baseFRight.rotateFor(950,rotationUnits::deg,30,velocityUnits::pct,false);
  baseBRight.rotateFor(950,rotationUnits::deg,30,velocityUnits::pct,false);
  baseFLeft.rotateFor(950,rotationUnits::deg,30,velocityUnits::pct,false);
  baseBLeft.rotateFor(950,rotationUnits::deg,30,velocityUnits::pct);
  ...
  baseFRight.startRotateFor(-700,rotationUnits::deg,55,velocityUnits::pct);
  ...
  // baseFRight.rotateFor(-480,rotationUnits::deg,50,velocityUnits::pct,false);
  baseFRight.startRotateFor(-500,rotationUnits::deg,50,velocityUnits::pct);
  baseBRight.rotateFor(-500,rotationUnits::deg,50,velocityUnits::pct,false);
  baseFLeft.rotateFor(500,rotationUnits::deg,50,velocityUnits::pct,false);
  baseBLeft.rotateFor(500,rotationUnits::deg,50,velocityUnits::pct);
  ...
  baseFRight.startRotateFor(480,rotationUnits::deg,50,velocityUnits::pct);
  baseBRight.rotateFor(480,rotationUnits::deg,50,velocityUnits::pct,false);
  baseFLeft.rotateFor(480,rotationUnits::deg,50,velocityUnits::pct,false);
  baseBLeft.rotateFor(480,rotationUnits::deg,50,velocityUnits::pct); 
  ...
  Holder.startRotateFor(-320,rotationUnits::deg,15,velocityUnits::pct);
...
void usercontrol( void ) {
  ...
  while (1) {
    ...
    if (Controller1.ButtonLeft.pressing()){
      Holder.spin(directionType::fwd,45,velocityUnits::pct);
    }

    else if(Controller1.ButtonA.pressing()){
      Holder.spin(directionType::rev,45,velocityUnits::pct);
    }
