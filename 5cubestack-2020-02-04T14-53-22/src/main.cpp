...
void autonomous (void) {
  ...
  intakeL.startRotateFor(2400,rotationUnits::deg,70,velocityUnits::pct);
  intakeR.rotateFor(2400,rotationUnits::deg,70,velocityUnits::pct,false);
  ...
  baseFRight.rotateFor(650,rotationUnits::deg,55,velocityUnits::pct,false);
  baseBRight.rotateFor(650,rotationUnits::deg,55,velocityUnits::pct,false);
  baseFLeft.rotateFor(650,rotationUnits::deg,55,velocityUnits::pct,false);
  baseBLeft.rotateFor(650,rotationUnits::deg,55,velocityUnits::pct); 

  task::sleep(800);

  Holder.startRotateFor(-300,rotationUnits::deg,40,velocityUnits::pct);

  task::sleep(600);

  intakeL.startRotateFor(-250,rotationUnits::deg,60,velocityUnits::pct);
  intakeR.rotateFor(-250,rotationUnits::deg,60,velocityUnits::pct);

  
  task::sleep(1000);

  intakeL.startRotateFor(-400,rotationUnits::deg,50,velocityUnits::pct);
  intakeR.rotateFor(-400,rotationUnits::deg,50,velocityUnits::pct,false);
  baseFRight.rotateFor(-400,rotationUnits::deg,50,velocityUnits::pct,false);
  baseBRight.rotateFor(-400,rotationUnits::deg,50,velocityUnits::pct,false);
  baseFLeft.rotateFor(-400,rotationUnits::deg,50,velocityUnits::pct,false);
  baseBLeft.rotateFor(-400,rotationUnits::deg,50,velocityUnits::pct);
